...
@Module({controllers:[FacilitiesController,FacilitiesAssetsController,FacilitiesPreventiveController,FacilitiesContractsController,FacilitiesAlertsController],providers:[PrismaService,FacilitiesAlertsService,FacilitiesPreventiveService]})
