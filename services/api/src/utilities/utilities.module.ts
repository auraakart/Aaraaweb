...
@Module({
  ...
  controllers: [UtilitiesController, UtilityChargesController, UtilityInvoicesController, UtilityResidentController],
  providers: [UtilitiesService, UtilityChargesService, UtilityInvoicesService, UtilityResidentService],
})
