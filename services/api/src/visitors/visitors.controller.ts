...
export class VisitorsController {
  ...
  verify(@Body() dto: GateCredentialDto, @CurrentTenant() societyId: string) { return this.verification.verify(societyId, dto.gateId, dto.credential); }

  @Post('check-in')
  @UseGuards(GateAccessGuard)
  checkIn(@Body() dto: GateCredentialDto, @CurrentTenant() societyId: string) { return this.verification.checkIn(societyId, dto.gateId, dto.credential); }

  @Post('check-out')
  @UseGuards(GateAccessGuard)
  checkOut(@Body() dto: GateCredentialDto, @CurrentTenant() societyId: string) { return this.verification.checkOut(societyId, dto.gateId, dto.credential); }
}
