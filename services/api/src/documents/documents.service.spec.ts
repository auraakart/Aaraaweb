...
describe('DocumentsService', () => {
  it('rejects property-owner-only document without unit', async () => {
    ...
    await expect(service.createDraft(
      ...
      {
        category:'PROPERTY', audience:'PROPERTY_OWNER_ONLY', title:'Sale deed', storageKey:'society/x', fileName:'deed.pdf', mimeType:'application/pdf', sizeBytes:100,
      },
  ...
  it('rejects cross-society property document unit', async () => {
    ...
    await expect(service.createDraft(
      ...
      '22222222-2222-4222-8222-222222222222',
      {
        unitId:'33333333-3333-4333-8333-333333333333', category:'PROPERTY', audience:'PROPERTY_OWNER_ONLY', title:'Sale deed', storageKey:'society/x', fileName:'deed.pdf', mimeType:'application/pdf', sizeBytes:100,
      },
    )).rejects.toBeInstanceOf(BadRequestException);
  });
  ...
  it('creates draft and event transactionally', async () => {
    ...
    const result = await service.createDraft(
      ...
      '22222222-2222-4222-8222-222222222222',
      {
        category:'BYLAW', audience:'ALL_MEMBERS', title:'Society bylaws', storageKey:'society/bylaw.pdf', fileName:'bylaw.pdf', mimeType:'application/pdf', sizeBytes:100,
      },
    );
