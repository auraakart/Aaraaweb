...
for(const fragment of ['Administration/governance | >= 8.7 | **9.','Overall repository evidence score:','Production/field readiness remains exactly 8.0'])if(!score.includes(fragment))throw new Error(`V4.15 score evidence continuity missing: ${fragment}`);
