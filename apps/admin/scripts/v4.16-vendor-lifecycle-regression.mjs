...
const required=['Vendor contracts & SLA evidence','/society-vendors/contracts','Renewal notice days','lifecycleState','does not determine legal validity or renewal obligations','Mark expired','Terminate']
