...
- one seeded society-less authenticated session.
...
The authenticated scenario exercises Bearer-token hashing/session validation, Redis-backed auth state, PostgreSQL relationship lookups and NestJS request/guard processing.
