...
Other entity types remain non-mutating until their domain-safe commit adapters are implemented.
...
6. Resident/vehicle/parking/workforce/vendor domain-safe commit adapters.
