...
Date: 2026-09-19  
Status: Repository-only evidence re-score after V4.20 Facilities, Assets & Work-Order Depth closure
...
The overall score is the simple arithmetic mean of the eight V4 program categories above: (9.3 + 9.5 + 9.0 + 9.6 + 9.1 + 9.1 + 9.4 + 8.0) / 8 = 9.125, reported as 9.13. V4.20 increases Administration/governance only where materially new facilities operator, readiness and contract/preventive evidence depth was added. Production/field readiness remains unchanged because real facility-team, physical inspection, provider/legal and hosted evidence remain external.

## Important boundary

The 9.13 score reflects repository implementation and automated evidence only. Production/field readiness remains exactly 8.0. V4.20 does not prove facility-team human acceptance, physical inspection outcomes, provider/AMC legal validity, hosted production behavior or real-society maintenance outcomes. Those require external evidence and remain outside this repository-only score.
