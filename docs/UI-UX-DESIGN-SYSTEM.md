...
The dedicated [V4.22 Admin consolidation milestone](AARAAGATE-V4.22-PROGRAM.md) defines the shared component contracts and ordered module migrations. Its implementation is planned; this document remains the brand and visual-language baseline.
